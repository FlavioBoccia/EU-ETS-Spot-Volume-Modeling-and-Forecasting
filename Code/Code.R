...
# Spot transactions
transaction <- read.csv("C:/Users/michi/OneDrive - Politecnico di Milano/Econometrics_project/eutl_2023/transaction.csv")
transaction$date <- as.Date(transaction$date)

# ICE Future prices
future_prices <- read.csv("C:/Users/michi/OneDrive - Politecnico di Milano/Econometrics_project/Daily_Future.csv")
future_prices$date <- as.Date(future_prices$Date)

# Brent prices
brent<- read.csv("C:/Users/michi/OneDrive - Politecnico di Milano/Econometrics_project/Brent Oil Futures Historical Data.csv")
brent$Date <- as.Date(brent$Date, format = "%m/%d/%Y")

# Coal prices
coal<- read.csv("C:/Users/michi/OneDrive - Politecnico di Milano/Econometrics_project/Coal.csv")
coal$date <- as.Date(paste0(substr(coal$Date, 1, 6), "20", substr(coal$Date, 7, 8)), format = "%m/%d/%Y")

# VIX index
vix<- read.csv("C:/Users/michi/OneDrive - Politecnico di Milano/Econometrics_project/vix.csv")
